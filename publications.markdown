...
* * Krause, C., Rieger, J., Flossdorf, J., Jentsch, C. and Beck, F. (2023, forthcoming). Visually Analyzing Topic Change Points in Temporal Text Collections. Accepted for Proceedings of the [Conference on Vision, Modeling, and Visualization](https://vmv2023.cg.cs.tu-bs.de/).
