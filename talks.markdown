...
* Exploring the potential of large language models (such as GPT-4) for (semi-)automatic content analysis of stances and frames in media texts. Erfurt, Germany (03/2024). DGPuK 2024. [Abstract](https://www.conftool.pro/dgpuk2024/index.php/Rieger-Exploring_the_potential_of_large_language_models-293.pdf?page=downloadPaper&filename=Rieger-Exploring_the_potential_of_large_language_models-293.pdf&form_id=293).
